...
перевіряє його на вміст заборонених слів зі списку (параметр spam_words), та повертає результат рядок, але замість заборонених слів, підставлений шаблон з *, 
...
def replace_spam_words(text, spam_words):
    for word in spam_words:
        text = re.sub(pattern=word, repl='*'*len(word), string=text, flags=re.IGNORECASE)
    return text    