...
Створіть функцію get_random_winners(quantity, participants), яка повертатиме список унікальних ідентифікаторів бази даних зі словника participants в кількості quantity. 
...
def get_random_winners(quantity, participants):
    if quantity > len(participants):
        ...
        winner_list = random.sample(part_list, k=quantity)
        print(winner_list)
        return winner_list